...
from stringComparison import findJaccardSimilarity 


def scrapeAmazon(searchFor):
    ...
    targetURL = "https://www.amazon.com/s?k" + searchFor.replace(' ', '+')
    ...
    bspPage = bsp.BeatifulSoup(targetPage)
